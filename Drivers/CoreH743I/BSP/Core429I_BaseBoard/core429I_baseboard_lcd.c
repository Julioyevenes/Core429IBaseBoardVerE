...
/* Includes ------------------------------------------------------------------*/
#include "core429I_baseboard_lcd.h"
...
__weak void BSP_LCD_MspInit(LTDC_HandleTypeDef *hltdc, void *Params)
{
  ...
  /* GPIOH configuration */
  gpio_init_structure.Pin       = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_8 |\
...
__weak void BSP_LCD_MspDeInit(LTDC_HandleTypeDef *hltdc, void *Params)
{
  ...
  /* GPIOE deactivation */
  gpio_init_structure.Pin       = GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6;  
  HAL_GPIO_DeInit(GPIOE, &gpio_init_structure);  

  /* GPIOG deactivation */
  gpio_init_structure.Pin       = GPIO_PIN_6 | GPIO_PIN_7 | GPIO_PIN_10 |\
								  GPIO_PIN_11 | GPIO_PIN_12;
  HAL_GPIO_DeInit(GPIOG, &gpio_init_structure);

  /* GPIOH deactivation */
  gpio_init_structure.Pin       = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_8 |\
								  GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 |\
								  GPIO_PIN_12 | GPIO_PIN_14 | GPIO_PIN_15;
  HAL_GPIO_DeInit(GPIOH, &gpio_init_structure);
  
  /* GPIOI deactivation */
  gpio_init_structure.Pin       = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 |\
								  GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 |\
								  GPIO_PIN_7 | GPIO_PIN_9 | GPIO_PIN_10;
  HAL_GPIO_DeInit(GPIOI, &gpio_init_structure); 
...
__weak void BSP_LCD_ClockConfig(LTDC_HandleTypeDef *hltdc, void *Params)
{
  ...
  periph_clk_init_struct.PLL3.PLL3M = 8;
  periph_clk_init_struct.PLL3.PLL3N = 48;
  periph_clk_init_struct.PLL3.PLL3R = RK043FN48H_FREQUENCY_DIVIDER;
