...
{ 
  ...
  if ((freqindex & 0x7) == 0)
  {
	...
	rccclkinit.PeriphClockSelection = RCC_PERIPHCLK_SPI3;
	rccclkinit.PLL2.PLL2M = 8;
	rccclkinit.PLL2.PLL2N = I2SPLLN[freqindex];
	rccclkinit.PLL2.PLL2P = I2SPLLR[freqindex];
	rccclkinit.Spi123ClockSelection = RCC_SPI123CLKSOURCE_PLL2;
  ...
  else 
  {
	...
	rccclkinit.PeriphClockSelection = RCC_PERIPHCLK_SPI3;
	rccclkinit.PLL2.PLL2M = 8;
	rccclkinit.PLL2.PLL2N = 271;
	rccclkinit.PLL2.PLL2P = 2;
	rccclkinit.Spi123ClockSelection = RCC_SPI123CLKSOURCE_PLL2;
	HAL_RCCEx_PeriphCLKConfig(&rccclkinit);
  }
}
...
__weak void BSP_AUDIO_OUT_MspInit(I2S_HandleTypeDef *hi2s, void *Params)
{
  ...
  if(hi2s->Instance == I2S3)
  {
    ...
    hdma_i2sTx.Init.Request             = I2S3_DMAx_REQUEST;
